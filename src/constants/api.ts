...
export const API_AUTH_PUBLIC_LOGIN = '/api/v1/auth/public-login'
export const API_AUTH_CHANGE_PASSWORD = '/api/v1/me/password'
...
export const API_ADMIN_APPROVAL_ASSIGN = '/api/v1/admin/approvals'
export const API_ADMIN_APPROVAL_REMIND = '/api/v1/admin/approvals'
export const API_ADMIN_APPROVAL_SCAN_OVERDUE = '/api/v1/admin/approvals/scan-overdue'
export const API_ADMIN_APPROVAL_APPLICATION_PDF_REGENERATE = '/api/v1/admin/approvals'
export const API_ADMIN_APPROVAL_CERTIFICATE_REGENERATE = '/api/v1/admin/approvals'
...
export const API_ADMIN_PARTYFLOW_STATUS_DETAIL = '/api/v1/admin/partyflow/statuses'
export const API_ADMIN_PARTYFLOW_STATUS_EVENTS = '/api/v1/admin/partyflow/statuses'
export const API_ADMIN_PARTYFLOW_REMINDER_RULES = '/api/v1/admin/partyflow/reminder-rules'
export const API_ADMIN_PARTYFLOW_REMINDERS_SCAN = '/api/v1/admin/partyflow/reminders/scan'

export const API_CERTIFICATE_ME_LIST = '/api/v1/certificates/me'
export const API_CERTIFICATE_DETAIL = '/api/v1/certificates'
export const API_CERTIFICATE_VERIFY = '/api/v1/certificates/verify'
export const API_ADMIN_CERTIFICATE_TEMPLATES = '/api/v1/admin/certificates/templates'
export const API_ADMIN_CERTIFICATE_REVOKE = '/api/v1/admin/certificates'
